...
<a class="navbar-brand" href="#" style="color:#FF0000">FoodHub</a>
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="menu.jsp" style="background-color: orange">North Indian</a></li>
            ...
            <c:forEach var="a" items="${value}" >
                ...
                <div class="column">
                    <div class="card" style="background-color: white">
                        <img src="${a.getCarimage()}" width="362px" height="340px"/> 
                        <div class="container">
                            <h5><b style="color:black">${a.getCarname()}</b></h5>
                            <p style="background-color: gray; width:330px; padding: 10px"><b  style="color: red"> Rs./- </b><b style="color: black">${a.getCarprice()}</b> <input style="margin-left: 140px" class ="btn btn-danger" data-toggle="modal" data-target="#myModal" type="button" value="Book Now"></p>
                        </div>
                    </div>
                </div>
            </c:forEach>
...
if(IndNum.test(IndianNumber))
  ...
  <textarea class="form-control" rows="5" name="baddress" required></textarea> 
    </div>
