...
<script>
    function al(form) {
if (form.cont.value=="foodhub@gmail.com") { 
if (form.apass.value=="fh@123") {              
...
<div id="id01" class="modal" >
  ...
  <form class="modal-content animate" action="logincheck.jsp" style="background-color: gray">
    ...
    <div class="container">
        ...
        <label><b style="color:white">Email Id</b></label><br>
...
<img src="images/fhji.jpg" class="img-responsive" style="width:100%"/>
