...
<div  style="background-color:orange; opacity: 0.4" class="abs-back"></div>
<div class="wel">
<div class="wel-info">
<h1>Know About Us</h1>
<span class="brk"></span>
<h3>Welcome to FoodHub.com - India's largest Restorent. FoodHub.com has always striven to serve car buyers and owners in the most comprehensive and convenient way possible. We provide a platform where car buyers and owners can research, buy, sell and come together to discuss and talk about their cars. 
  ...
  <div  style="background-color:blueviolet;"class="col-sm-12 col-md-12 text-center">
    ...
    <div class="thumbnail">
      <img src="images/niit_one.jpg" alt="niit pic one">
       <img class="team-pic" src="images/icon1.png">
      <div class="caption">
        <h3>Prachi Sharma</h3>
        <p class="card-description">I recently took a taste of Food, I found it a very Tasty. Apart from being a 5 dishes this food has an spices taste in almost all the resturant from Delhi to All India, we like its, features, taste or spicies. I am definitely planning to buy this food, Good job </div>
    </div>  
...
<p class="rights"><!-- dont remove link --><a class="dont-remove" href="http://webdeveloperbareilly.in" target="_blank">www.FoodHub.com</a></p>
